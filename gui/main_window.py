...
class VideoConverterWindow(QMainWindow):
    ...
    def install_ffmpeg(self):
        ...
        if success:
            ...
            QMessageBox.warning(self, "Erro", "Não foi possível instalar o FFmpeg automaticamente.")
    ...
    def start_conversion(self):
        ...
        if not self.input_file_edit.text():
            QMessageBox.warning(self, "Erro", "Selecione um arquivo de vídeo de entrada.")
            return
    ...
    def set_conversion_state(self, converting):
        ...
        self.fps_custom.setEnabled(not converting and self.fps_combo.currentText() == 'Personalizado')
        self.resolution_combo.setEnabled(not converting)
        self.width_spin.setEnabled(not converting and self.resolution_combo.currentText() == 'Personalizada')
        self.height_spin.setEnabled(not converting and self.resolution_combo.currentText() == 'Personalizada')
