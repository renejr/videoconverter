...
class ProgressStyle:
    ...
    STYLES = {
        "classic": {"filled": "█", "empty": "░", "prefix": "[", "suffix": "]"},
        "modern": {"filled": "▰", "empty": "▱", "prefix": "│", "suffix": "│"},
...
class ProgressBar:
    ...
    def _render(self):
        ...
        filled_width = (
            (self.current * self.width) // self.total if self.total > 0 else 0
        )
...
class MultiProgressBar:
    ...
    def add_bar(
        self, name: str, total: int, description: str = "", **kwargs
    ) -> ProgressBar:
        """
...
def create_progress_bar(
    total: int, description: str = "", style: str = "classic", color: str = "download"
) -> ProgressBar:
    """
