...
class Logger:
    ...
    def __init__(self, name: str = "VideoConverter-Installer", log_dir: Optional[str] = None):
        """
    ...
    def installation_summary(self, results: Dict[str, bool]):
        ...
        if success_count == total_count:
            self.success(f"Instalação concluída com sucesso! ({success_count}/{total_count})")
        else:
            self.error(f"Instalação parcial: {success_count}/{total_count} componentes instalados")
