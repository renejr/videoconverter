...
class TestIntegration(unittest.TestCase):
    ...
    def test_component_interaction(self):
        ...
        self.assertIsNotNone(python_current)  # Pode ser None se Python não estiver instalado
        self.assertIsInstance(gpus, list)
...
class TestPerformance(unittest.TestCase):
    ...
    def test_system_detection_speed(self):
        ...
        self.assertLess(detection_time, 5.0, 
                       f"Detecção muito lenta: {detection_time:.2f}s")
        self.assertIsInstance(os_info, OSInfo)
    ...
    def test_python_detection_speed(self):
        ...
        self.assertLess(detection_time, 10.0,
                       f"Detecção Python muito lenta: {detection_time:.2f}s")
        self.assertIsInstance(installations, list)
...
Exemplos de uso:
  ...
  python test_installer.py --method test_detect_os # Método específico
    ...
    parser.add_argument("--class", dest="test_class",
                       help="Executar classe de teste específica")
    parser.add_argument("--method", dest="test_method",
                       help="Executar método de teste específico")
