...
def test_imports():
    ...
    try:
        ...
        assert False, f"Erro na importação: {e}"
...
def test_configurations():
    ...
    try:
        ...
        assert False, f"Erro nas configurações: {e}"
...
def test_validators():
    ...
    try:
        ...
        settings = {"fps": 30, "resolution": "1920x1080", "quality": "medium"}
        ...
        assert False, f"Erro nos validadores: {e}"
...
def test_ffmpeg_installer():
    ...
    try:
        ...
        assert False, f"Erro no FFmpeg Installer: {e}"
    ...
    try:
        ...
        try:
            ...
            try:
                ...
                print(
                    "✓ Verificação de formato detectou arquivo inexistente (esperado)"
                )
        ...
        assert False, f"Erro no Video Converter: {e}"
...
def test_tkinter_interface():
    ...
    try:
        ...
        assert hasattr(
            app, "output_dir_var"
        ), "Variável de diretório de saída não encontrada"
        assert hasattr(app, "format_combo"), "Combo de formato de saída não encontrado"
        assert hasattr(app, "progress_var"), "Variável de progresso não encontrada"
        assert hasattr(app, "selected_files"), "Lista de arquivos selecionados não encontrada"
        ...
        assert False, f"Erro na interface Tkinter: {e}"
