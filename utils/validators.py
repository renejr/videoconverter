...
def validate_frame_extraction_settings(frame_settings):
    ...
    if extraction_mode == 'Intervalo Regular':
        ...
        try:
            frame_numbers = [int(f.strip()) for f in specific_frames.split(',') if f.strip()]
            ...
            return False, "Números de frames devem ser números inteiros válidos separados por vírgula"
